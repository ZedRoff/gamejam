    ...
    def setup(self):
        ...
        self.frames = [
           ...
           BD(0,0,"./assets/bg_1_4.png", delay=1, clear=True),
            ...
            BD(width // 2, height // 2, "./assets/armoire.png", delay=0.1),
            BD(width // 2, height // 2, "./assets/couloir_door.png", delay=1),
            BD(width // 2, height // 2, "./assets/couloir_character1.png", delay=1, should_be_deleted=True),
